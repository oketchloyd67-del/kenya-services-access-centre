...
async function searchJobs(page = 1) {
    ...
    try {
        ...
        const response = await fetch(`https://kenyaservices-accesscentre-ly34.onrender.com/api/jobs/search?${params}`, {
...
async function getEmployerDetails(jobId) {
    ...
    try {
        const response = await fetch('https://kenyaservices-accesscentre-ly34.onrender.com/api/jobs/get-employer-details', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${getAuthToken()}`
...
async function submitApplication(event) {
    ...
    try {
        const response = await fetch('https://kenyaservices-accesscentre-ly34.onrender.com/api/jobs/apply', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${getAuthToken()}`
            },
