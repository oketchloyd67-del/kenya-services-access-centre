...
async function searchServices(page = 1) {
    ...
    try {
        ...
        const response = await fetch(`https://kenyaservices-accesscentre-ly34.onrender.com/api/services/search?${params}`, {
...
async function submitConnection(event) {
    ...
    try {
        const response = await fetch('https://kenyaservices-accesscentre-ly34.onrender.com/api/services/connect', {
            method: 'POST',
            headers: {
...
async function viewProviderProfile(providerId) {
    ...
    try {
        const response = await fetch(`https://kenyaservices-accesscentre-ly34.onrender.com/api/services/${providerId}`, {
            headers: { 'Authorization': `Bearer ${getAuthToken()}` }
        });
        const data = await response.json();
...
async function loadServiceCategories() {
    try {
        const response = await fetch('https://kenyaservices-accesscentre-ly34.onrender.com/api/services/categories/list');
        const data = await response.json();
